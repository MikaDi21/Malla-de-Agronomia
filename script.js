// Lista completa de cursos con sus requisitos
const cursos = [
...
// Estado actual de cada curso (aprobado o no)
const estadoCursos = {};

// Función para dibujar la malla curricular
...
// Inicializa la malla al cargar la página
renderMalla();
